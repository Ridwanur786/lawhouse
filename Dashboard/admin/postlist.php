            ...
            <div class="box round first grid">
                ...
                <div class="block">  
                    ...
                    ?>
						<tr class="odd gradeX">
							<td><?php echo $i;?></td>
                            <td><a href="postEdit.php?editId= <?php echo $result['id'];?>"><?php echo $result['title'];?></a></td>
							<td><?php echo $fm->textShorten($result['body'],60);?> </td>
							<td> <?php echo $result['name'];?></td>
                            <td><img src="<?php echo $result['img'];?>" height="60px;" width="100px;"/></td>
							...
							<td>   <a href="viewPost.php?viewPostid=<?php echo $result['id'];?>">View</a>
                                ...
                                if (Session::get('userId')== $result['userid']||Session::get('userRole')=='0')
                                {
                                    ...
                                    ||
                                    <a onclick="return confirm('ARE YOU SURE TO DELETE THIS CATEGORY?')" href="postDelete.php?deletepostid= <?php echo $result['id'];?>">Delete</a>
                                    <?php
                                }
                                ?>
