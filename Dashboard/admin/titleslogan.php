    ...
    .right_side img{
        ...
        <div class="grid_10">
            ...
            <div class="box round first grid">
                ...
                $slgUpdate = $db->select($slgQuery);
                if(  $slgUpdate )
                {
                    while($slgResult =  $slgUpdate ->fetch_assoc())
                    {
                ?>
                <div class="block sloginblock">
                    ...
                    <table class="form">					
                        <tr>
                            ...
                            <td>
                                <input type="text" value="<?php echo $slgResult['title']; ?>"  name="title" class="medium" />
                            </td>
                        </tr>
						 ...
						 <tr>
                            ...
                            <td>
                                <input type="text"  value="<?php echo $slgResult['slogan']; ?>" name="slogan" class="medium"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <div class="right_side">
                        <img src="<?php echo $slgResult['logo']; ?>" alt="logo">
                    </div>
                </div>
                <?php
                    }
